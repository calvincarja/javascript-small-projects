...
// encoded
javascript:function%20testlocalstorage(){try{let%20e=%22test%20local%20storage%22;localStorage.setItem(e,e);localStorage.removeItem(e);return!0}catch(e){return!1}}function%20check4class(e=1){const%20t=testlocalstorage();let%20o;if(t){console.log(%22local%20storage%20available,%20will%20store%20refresh%22),o=parseInt(localStorage.getItem(%22refresh%22)||%220%22);const%20c=document.querySelector(%22.col-sm-12%22);if(!c){if(e<=4)console.log(%60class%20not%20found,%20will%20re-try%20in%2010%20seconds%20(attempt%20${e}/4)%60),setTimeout(()=>{check4class(e+1)},1e4);else%20if(o<3)console.log(%22Max%20attempts%20reached,%20refreshing%20the%20page%22),localStorage.setItem(%22refresh%22,o+1),localStorage.setItem(%22attempt%22,%221%22),location.reload(!0);else%20console.log(%22after%20maximum%20amount%20of%20refreshes,%20class%20was%20not%20found.%22),localStorage.removeItem(%22refresh%22),localStorage.removeItem(%22attempt%22)}else{console.log(%22class%20found%22),localStorage.removeItem(%22refresh%22),localStorage.removeItem(%22attempt%22);const%20e=Array.from(document.querySelectorAll(%22label%22)),t=Array.from(document.querySelectorAll(%22input%22)),o=e.findIndex(e=>e.textContent.trim().includes(%22Title%22));console.log(o)}}else{console.log(%22local%20storage%20not%20available,%20will%20need%20to%20manually%20refresh%20after%20set%20timeout%20is%20complete%22),o=0;const%20t=document.querySelector(%22.col-sm-12%22);if(!t){if(e<=4)console.log(%60class%20not%20found,%20will%20re-try%20in%2010%20seconds%20(attempt%20${e}/4)%60),setTimeout(()=>{check4class(e+1)},1e4);else%20console.log(%22class%20was%20not%20found.%20please%20refresh%20the%20page


// the IIFE did not work, but i did learn that after each refresh, the refresh is being saved in the local storage
// thus will keep the first version, just changing the code from 10 seconds to one minute

// minifed code
javascript:function%20testlocalstorage(){try{let%20e=%22test%20local%20storage%22;localStorage.setItem(e,e);localStorage.removeItem(e);return!0}catch(e){return!1}}function%20check4class(e=1){const%20t=testlocalstorage();let%20o;if(t){console.log(%22local%20storage%20available,%20will%20store%20refresh%22),o=parseInt(localStorage.getItem(%22refresh%22)||%220%22);const%20c=document.querySelector(%22.col-sm-12%22);if(!c){if(e<=4)console.log(%60class%20not%20found,%20will%20re-try%20in%2010%20seconds%20(attempt%20${e}/4)%60),setTimeout(()=>{check4class(e+1)},6e4);else%20if(o<3)console.log(%60Max%20attempts%20reached,%20refreshing%20the%20page.%20Refresh%20count:%20${o}%60),localStorage.setItem(%22refresh%22,o+1),location.reload(!0);else%20console.log(%22after%20maximum%20amount%20of%20refreshes,%20class%20was%20not%20found.%22),localStorage.removeItem(%22refresh%22)}else{console.log(%22class%20found%22),localStorage.removeItem(%22refresh%22);const%20e=Array.from(document.querySelectorAll(%22label%22)),t=Array.from(document.querySelectorAll(%22input%22)),o=e.findIndex(e=>e.textContent.trim().includes(%22Title%22));console.log(o)}}else{console.log(%22local%20storage%20not%20available,%20will%20need%20to%20manually%20refresh%20after%20set%20timeout%20is%20complete%22),o=0;const%20t=document.querySelector(%22.col-sm-12%22);if(!t){if(e<=4)console.log(%60class%20not%20found,%20will%20re-try%20in%2010%20seconds%20(attempt%20${e}/4)%60),setTimeout(()=>{check4class(e+1)},6e4);else%20console.log(%22class%20was%20not%20found.%20please%20refresh%20the%20page%20manually%22)}else{console.log(%22class%20found%22);const%20e=Array.from(document.querySelectorAll(%22label%22)),t=Array.from(document.querySelectorAll(%22input%22)),o=e.findIndex(e=>e.textContent.trim().includes(%22Title%22));console.log(o)}}}check4class();

//encoded
javascript:function%20testlocalstorage(){try{let%20e=%22test%20local%20storage%22;localStorage.setItem(e,e);localStorage.removeItem(e);return!0}catch(e){return!1}}function%20check4class(e=1){const%20t=testlocalstorage();let%20o;if(t){console.log(%22local%20storage%20available,%20will%20store%20refresh%22),o=parseInt(localStorage.getItem(%22refresh%22)||%220%22);const%20c=document.querySelector(%22.col-sm-12%22);if(!c){if(e<=4)console.log(%60class%20not%20found,%20will%20re-try%20in%201%20minute%20(attempt%20${e}/4)%60),setTimeout(()=>{check4class(e+1)},6e4);else%20if(o<3)console.log(%60Max%20attempts%20reached,%20refreshing%20the%20page.%20Refresh%20count:%20${o}%60),localStorage.setItem(%22refresh%22,o+1),location.reload(!0);else%20console.log(%22after%20maximum%20amount%20of%20refreshes,%20class%20was%20not%20found.%22),localStorage.removeItem(%22refresh%22)}else{console.log(%22class%20found%22),localStorage.removeItem(%22refresh%22);const%20e=Array.from(document.querySelectorAll(%22label%22)),t=Array.from(document.querySelectorAll(%22input%22)),o=e.findIndex(e=>e.textContent.trim().includes(%22Title%22));console.log(o)}}else{console.log(%22local%20storage%20not%20available,%20will%20need%20to%20manually%20refresh%20after%20set%20timeout%20is%20complete%22),o=0;const%20t=document.querySelector(%22.col-sm-12%22);if(!t){if(e<=4)console.log(%60class%20not%20found,%20will%20re-try%20in%201%20minute%20(attempt%20${e}/4)%60),setTimeout(()=>{check4class(e+1)},6e4);else%20console.log(%22class%20was%20not%20found.%20please%20refresh%20the%20page%20manually%22)}else{console.log(%22class%20found%22);const%20e=Array.from(document.querySelectorAll(%22label%22)),t=Array.from(document.querySelectorAll(%22input%22)),o=e.findIndex(e=>e.textContent.trim().includes(%22Title%22));console.log(o)}}}check4class();
